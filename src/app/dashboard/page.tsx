...
export default function DashboardPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "20px 20px 100px" }} className="page-enter">
      ...
      <p style={{ fontSize: 15, color: "#8D91B5", marginTop: 4 }}>Restez en sécurité</p>
      ...
      <button onClick={() => router.push("/sos")} style={{ position: "fixed", bottom: 100, right: "calc(50% - 195px)", width: 56, height: 56, borderRadius: 28, background: "linear-gradient(135deg, #FF375F, #FF1744)", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 20px rgba(255,55,95,0.5)", zIndex: 40 }}>
